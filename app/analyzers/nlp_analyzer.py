...
IMPORTANT LIMITATION (documented as required by the project brief):
This is keyword/phrase-based detection, not true NLP understanding.
It can miss cleverly-worded phishing that avoids these exact phrases,
and can occasionally flag legitimate urgent emails (e.g. a real
deadline reminder) as suspicious. This module is one signal among
several in the Correlation Engine (Phase 11) -- it is not meant to
be a standalone verdict. A trained ML model (Phase 8) complements
this by learning patterns beyond fixed keyword lists.
"""
